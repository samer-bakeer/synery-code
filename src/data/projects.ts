...
export const projects: Project[] = [
  // ===== WEB DEVELOPMENT PROJECTS (10) =====
  {
    ...
    image: 'https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjB3ZWJzaXRlfGVufDF8fHx8MTc2MDU0MzY5NHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    detailImage: 'https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2UlMjB3ZWJzaXRlfGVufDF8fHx8MTc2MDU0MzY5NHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    liveDemo: 'https://example.com',
    sourceCode: 'https://github.com/synerycode/ecoshop',
    featured: true,
    timeline: '3 months',
    ...
    achievements: [
      ...
      'Integrated with 3 major payment gateways'
    ]
  },
  {
    id: 'web-2',
    ...
    fullDescription: 'A powerful enterprise-grade analytics dashboard that provides real-time insights into business metrics and KPIs. The platform features customizable widgets, interactive data visualizations using D3.js, automated report generation, and role-based access control. Built with Vue.js for a responsive and dynamic user experience, backed by Python microservices and PostgreSQL for robust data processing.',
    category: 'web',
    technologies: ['Vue.js', 'D3.js', 'Python', 'PostgreSQL', 'Docker', 'Redis'],
    image: 'https://images.unsplash.com/photo-1666875753105-c63a6f3bdc86?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbmFseXRpY3MlMjBkYXNoYm9hcmR8ZW58MXx8fHwxNzYwNTA5NTI3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    detailImage: 'https://images.unsplash.com/photo-1666875753105-c63a6f3bdc86?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbmFseXRpY3MlMjBkYXNoYm9hcmR8ZW58MXx8fHwxNzYwNTA5NTI3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    liveDemo: 'https://example.com',
    sourceCode: 'https://github.com/synerycode/analytics-dashboard',
    featured: false,
    timeline: '5 months',
    teamSize: '6 developers',
    achievements: [
      'Processes 1M+ data points per day',
  ...
  },
  {
    ...
    fullDescription: 'EduLearn is a comprehensive learning management system designed for educational institutions and corporate training programs. The platform features course creation and management tools, HD video streaming with adaptive bitrate, interactive quizzes and assessments, student progress tracking, real-time collaboration tools, and certificate generation. Built with Next.js for optimal performance and SEO, deployed on Vercel edge network for global accessibility.',
    category: 'web',
    technologies: ['Next.js', 'Prisma', 'Tailwind', 'Vercel', 'PostgreSQL', 'AWS S3'],
    image: 'https://images.unsplash.com/photo-1588912914074-b93851ff14b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBsZWFybmluZyUyMHBsYXRmb3JtfGVufDF8fHx8MTc2MDQ3NTkxMHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    detailImage: 'https://images.unsplash.com/photo-1588912914074-b93851ff14b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBsZWFybmluZyUyMHBsYXRmb3JtfGVufDF8fHx8MTc2MDQ3NTkxMHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    liveDemo: 'https://example.com',
    sourceCode: 'https://github.com/synerycode/edulearn',
    featured: true,
    timeline: '6 months',
  ...
  },
  {
    ...
    description: 'Modern corporate website with dynamic content management and multilingual support.',
    fullDescription: 'A sophisticated corporate website built for a leading technology company. Features include dynamic content management system, multilingual support for 10+ languages, career portal with application tracking, investor relations section, news and press release management, and integrated blog. The site is optimized for SEO and delivers exceptional performance across all devices.',
    category: 'web',
    technologies: ['React', 'Gatsby', 'Contentful', 'GraphQL', 'Netlify'],
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMHdlYnNpdGV8ZW58MXx8fHwxNzYwNTU2MTQ4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    liveDemo: 'https://example.com',
    sourceCode: 'https://github.com/synerycode/techcorp-website',
    featured: false,
    timeline: '4 months',
